...
using Angular.Services.Services;
using AngularAPI.Services.Services;
...
namespace Angular
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<AngularAPIContext>(options =>
            options.UseSqlServer(Configuration.GetConnectionString("AngularDatabase")));

            services.AddTransient<IAttendanceServices, AttendanceServices>();
            services.AddTransient<IClassesServices, ClassesServices>();
            services.AddTransient<IDeparmentServices, DeparmentServices>();
            services.AddTransient<ISectionServices, SectionServices>();
            services.AddTransient<IShedulesServices, ScheduleServices>();
